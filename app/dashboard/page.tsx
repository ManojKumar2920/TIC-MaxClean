    ...
    const fetchOrders = async () => {
      try {
        ...
        const calculateMetrics = (orders: {
          filter: (arg0: { (order: any): boolean; (order: any): boolean }) => {
            (): any;
            new (): any;
            reduce: {
              (arg0: (sum: any, order: any) => any, arg1: number): any;
              new (): any;
            };
            length: any;
          };
          ...
          const revenue = orders
            ...
            .reduce(
              (sum: any, order: { price: any }) => sum + (order.price || 0),
              0
            );
          ...
          <header className="bg-[#afafaf] rounded-[10px] p-4 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div onClick={handleAvatarClick} className="cursor-pointer">
                <img src="https://avatar.iran.liara.run/public/28" width={40} height={40} alt="" />
              </div>
            </div>
          </header>
        </div>
