...
const Footer = () => {
  return (
    <footer className="bg-black z-[180] text-white   pt-20 w-full ">
      ...
      <div className="bg-black flex flex-col  md:gap-8 gap-10 item-start md:items-center  md:px-16  px-4    pb-10 pt-16">
        ...
        <div className="container mx-auto text-center md:flex  md:justify-between md:items-start">
          ...
          <div className=" bg-black md:gap-0 gap-2  md:mb-0 mb-2 md:flex-row flex-col flex justify-between  px-4 w-full md:px-28  py-4 ">
