...
export const sendRejectMail = async (
  ...
  userMessage: string // User-provided message for the rejection
) => {
  ...
  const mailOptions = {
    ...
    subject: "Order Rejected - Reason Provided",
    html: `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
  <div class="email-container">
    ...
    <div class="content">
      <h2>Dear ${name},</h2>
      <p>We regret to inform you that your order has been rejected. Below are the details of your order along with the reason for rejection:</p>
      ...
      <p><strong>Reason for Rejection:</strong> ${userMessage}</p>

      <p>If you have any further questions or would like to discuss the matter, please don't hesitate to reach out to us at <a href="mailto:maxcleanbusiness@gmail.com">maxcleanbusiness@gmail.com</a>.</p>
      <p>We sincerely apologize for any inconvenience caused and hope to serve you in the future.</p>
